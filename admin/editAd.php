	...
	<div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                <li><a href="admin.php?dog=0"><span class="glyphicon glyphicon-arrow-left"></span></a></li> 
            </ul>
        </div><!--collapse-->
    </div><!--container-fluid-->
</nav><!--navbar-->
...
<div class="container">  
    <?php 
		...
		$sql="select * from tbladmin where maAd=$ma";
		$result=mysqli_query($conn,$sql);
		$row=mysqli_fetch_array($result);
	?>
    	<h1>Sửa thông tin cá nhân</h1>
    	<form action="editAdXuLy.php" class="form-horizontal" method="post" >
        	<div class="form-group">
            	<label class="control-label col-sm-4">Mã tài khoản:</label>
                <div class="col-sm-4">
                	<input type="text" class="form-control" id="txtMa" name="txtMa" readonly="readonly" value="<?php echo $row["maAd"]?>">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-4">
                	<input type="text" class="form-control" id="txtNgaySinh" name="txtNgaySinh" value="<?php echo $row["ngaySinh"]?>"> <span id="errName"></span>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                	<input type="submit" class="btn btn-success" value="Sửa thông tin" onclick="return editAdVal()">
