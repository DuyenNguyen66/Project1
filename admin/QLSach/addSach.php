...
?>
<h1>Thêm truyện</h1>
<form action="QLSach/addSachXuLy.php" class="form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
        	<input type="text" id="txtMoTa" name="txtMoTa" class="form-control">
        </div>
    </div>
    <div class="form-group">
