<form method="get" class="navbar-form navbar-right">
	...
	<input type="text" name="txtSearch" placeholder="Tên tác phẩm..." class="form-control" value="<?php if(isset($_GET["txtSearch"])){echo($_GET["txtSearch"]);}?>"/>
    ...
    <?php 
		...
		//loc san pham
		$sql="select * from tblsach inner join tbltheloai on tblsach.maTl=tbltheloai.maTl
							 where tenSach like '%$search%' or tenTg like '%$search%' or tenTl like '%$search%' limit $start,$end";
		$result=mysqli_query($conn,$sql);
    	...
    	<table class="table table-responsive">
			...
			?>
            	<tr>
                    ...
                    <td><a href="QLSach_Nv/editSach.php?maSach=<?php echo $row["maSach"]?>">Sửa</td>
                    <td><a href="QLSach_Nv/deleteSachXuLy.php?maSach=<?php echo $row["maSach"]?>" onclick="return confirm('Bạn chắc chắn muốn xóa sách này?')">Xóa</td>
            	</tr>   
          <?php	
				}
		  ?>
